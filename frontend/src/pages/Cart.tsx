    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          {cart.map((item) => (
            <div key={item._id} className="card p-6 hover:shadow-lg transition-shadow duration-200">
                ...
                <div className="flex-1 space-y-3">
                  <div>
                    <Link 
                      ...
                      className="text-xl font-semibold text-gray-900 hover:text-primary-600 block"
                    >
                      {item.product.name}
                    </Link>
          ...
          <div className="card p-6 text-center">
            ...
            <p className="text-gray-600 mb-4">Continue shopping to discover more amazing products</p>
