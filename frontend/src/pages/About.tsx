      ...
      <section className="relative bg-gradient-to-r from-primary-600 to-secondary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold font-heading">About ShopCart.com</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-300">support@shopcart.com</p>
              <p className="text-gray-300">info@shopcart.com</p>
            </div>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="input-field bg-gray-800 border-gray-700 text-white placeholder-gray-400"
                />
                <input
                  type="email"
              ...
              <textarea
                ...
                className="input-field bg-gray-800 border-gray-700 text-white placeholder-gray-400 resize-none"
              ></textarea>
